...
equation
  connect(AC,diode1. term_p) annotation (Line(points={{100,0},{-6.12323e-16,0},
            {-6.12323e-16,20}}, color={0,0,255}));
  connect(diode1.term_n, pn_p_n.term_p) annotation (Line(points={{6.12323e-16,
            40},{0,40},{0,50},{-40,50},{-40,4},{-44,4}}, color={0,0,255}));
  connect(pn_p_n.term_n,diode2. term_p) annotation (Line(points={{-44,-4},{-40,
            -4},{-40,-50},{0,-50},{0,-40},{-6.12323e-16,-40}}, color={0,0,255}));
  connect(diode2.term_n, AC) annotation (Line(points={{6.12323e-16,-20},{
            6.12323e-16,0},{100,0}}, color={0,0,255}));
...
equation
  connect(AC, switch_D1.term_n) annotation (Line(points={{100,0},{-6.12323e-16,
            0},{-6.12323e-16,20}}, color={0,0,255}));
  connect(switch_D1.term_p, pn_p_n.term_p) annotation (Line(points={{
            6.12323e-16,40},{0,40},{0,50},{-40,50},{-40,4},{-64,4}}, color={0,0,
            255}));
  connect(AC, switch_D2.term_p) annotation (Line(points={{100,0},{6.12323e-16,0},
            {6.12323e-16,-20}}, color={0,0,255}));
  connect(switch_D2.term_n, pn_p_n.term_n) annotation (Line(points={{
            -6.12323e-16,-40},{0,-40},{0,-50},{-40,-50},{-40,-4},{-64,-4}},
          color={0,0,255}));
