...
equation
  connect(AC, rectifier.AC)    annotation (Line(points={{100,0},{10,0}}, color=
            {0,120,120}));
...
model RectifierModular "Rectifier modular, 3-phase"
  ...
  Nodes.ACabc_a_b_c acabc_a_b_c annotation (Placement(transformation(extent={{
                80,-10},{60,10}}, rotation=0)));
  Common.Thermal.Heat_a_b_c_abc heat_adapt annotation (Placement(transformation(
...
equation
  connect(AC, acabc_a_b_c.term) annotation (Line(points={{100,0},{80,0}}, color
            ={0,120,120}));
  connect(acabc_a_b_c.term_a, diodeMod_a.AC) annotation (Line(points={{60,4},{
              40,4},{40,40},{10,40}}, color={0,0,255}));
  connect(acabc_a_b_c.term_b, diodeMod_b.AC)
      annotation (Line(points={{60,0},{10,0}}, color={0,0,255}));
  connect(acabc_a_b_c.term_c, diodeMod_c.AC) annotation (Line(points={{60,-4},{
              40,-4},{40,-40},{10,-40}}, color={0,0,255}));
  connect(diodeMod_a.DC, DC) annotation (Line(points={{-10,40},{-40,40},{-40,0},
              {-100,0}}, color={0,0,255}));
  connect(diodeMod_b.DC, DC)
      annotation (Line(points={{-10,0},{-100,0}}, color={0,0,255}));
  connect(diodeMod_c.DC, DC) annotation (Line(points={{-10,-40},{-40,-40},{-40,
              0},{-100,0}}, color={0,0,255}));
  connect(diodeMod_a.heat, heat_adapt.port_a) annotation (Line(points={{0,50},{
              0,60},{-4,60},{-4,74}}, color={176,0,0}));
  connect(diodeMod_b.heat, heat_adapt.port_b) annotation (Line(points={{0,10},{
              0,20},{20,20},{20,64},{0,64},{0,74}}, color={176,0,0}));
...
equation
  ...
  connect(AC, acabc_a_b_c.term) annotation (Line(points={{100,0},{80,0}}, color
            ={0,120,120}));
  connect(gate3demux1.gates_a, switchMod_a.gates) annotation (Line(points={{-46,
              60},{-46,56},{-6,56},{-6,50}}, color={255,0,255}));
  connect(gate3demux1.gates_b, switchMod_b.gates) annotation (Line(points={{-40,
              60},{-40,20},{-6,20},{-6,10}}, color={255,0,255}));
  connect(gate3demux1.gates_c, switchMod_c.gates) annotation (Line(points={{-34,
              60},{-34,-20},{-6,-20},{-6,-30}}, color={255,0,255}));
  connect(acabc_a_b_c.term_a, switchMod_a.AC) annotation (Line(points={{60,4},{
              40,4},{40,40},{10,40}}, color={0,0,255}));
  connect(switchMod_a.DC, DC) annotation (Line(points={{-10,40},{-60,40},{-60,0},
              {-100,0}}, color={0,0,255}));
  connect(acabc_a_b_c.term_b, switchMod_b.AC)
    annotation (Line(points={{60,0},{10,0}}, color={0,0,255}));
  connect(switchMod_b.DC, DC)
    annotation (Line(points={{-10,0},{-100,0}}, color={0,0,255}));
  connect(acabc_a_b_c.term_c, switchMod_c.AC) annotation (Line(points={{60,-4},
              {40,-4},{40,-40},{10,-40}}, color={0,0,255}));
  connect(switchMod_c.DC, DC) annotation (Line(points={{-10,-40},{-60,-40},{-60,
              0},{-100,0}}, color={0,0,255}));
  connect(switchMod_a.heat, heat_adapt.port_a) annotation (Line(points={{0,50},
              {0,60},{-4,60},{-4,74}}, color={176,0,0}));
  connect(switchMod_b.heat, heat_adapt.port_b) annotation (Line(points={{0,10},
              {0,20},{20,20},{20,64},{0,64},{0,74}}, color={176,0,0}));
  connect(switchMod_c.heat, heat_adapt.port_c) annotation (Line(points={{0,-30},
              {0,-20},{30,-20},{30,74},{4,74}}, color={176,0,0}));
  connect(heat_adapt.port_abc, heat)
        annotation (Line(points={{0,86},{0,100}}, color={176,0,0}));
annotation (defaultComponentName="inverter",
