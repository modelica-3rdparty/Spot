...
"), Icon(coordinateSystem(
  ...
  model Fault_ca "c to a fault, 3-phase abc"
...
"), Icon(coordinateSystem(
  ...
  model Fault_ab "a to b fault, 3-phase abc"
...
"), Icon(coordinateSystem(
  ...
  model Fault_abc "a to b to c fault, 3-phase abc"
    extends Partials.FaultBase;
...
"),   Icon(coordinateSystem(
  ...
  model Fault_B "b to ground fault, 3-phase abc"
...
"),   Icon(coordinateSystem(
  ...
  model Fault_C "c to ground fault, 3-phase abc"
...
"),   Icon(coordinateSystem(
  ...
  model Fault_bC "b to c to ground fault, 3-phase abc"
...
"),   Icon(coordinateSystem(
  ...
  model Fault_cA "c to a to ground fault, 3-phase abc"
...
"),   Icon(coordinateSystem(
  ...
  model Fault_aB "a to b to ground fault, 3-phase abc"
...
"),   Icon(coordinateSystem(
  ...
  model Fault_Abc "b to a, c to a, a to ground fault, 3-phase abc"
...
"),   Icon(coordinateSystem(
  ...
  package Partials "Partial models"
    ...
    partial model FaultBase "Line fault base, 3-phase abc"
...
when the line is disconnected from its sources. For disconnecting switches with zero 'open' conductivity, epsG can not be set to zero.</p>
<p>Terminology:<br>
...
"),     Diagram(coordinateSystem(
    ...
    partial model Fault_pp "Two-phase fault, 3-phase abc"
    ...
    partial model Fault_pg "One-phase to ground fault, 3-phase abc"
      extends FaultBase(final n_phRef=n_ph);
    ...
    partial model Fault_ppg "Two-phase to ground fault, 3-phase abc"
      extends FaultBase(final n_phRef=n_ph);
    ...
    partial model Fault_pppg "Three-phase to ground fault, 3-phase abc"
      extends FaultBase;
