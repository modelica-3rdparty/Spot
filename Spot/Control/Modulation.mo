...
"), Icon(coordinateSystem(
    ...
    Diagram(coordinateSystem(
          ...
          Line(points={{-40,60},{-54,60},{-54,50}}, color={128,0,255})}),
                  extent=[-74,68; -54,48],
      Placement(transformation(extent={{-74,68},{-54,48}}, rotation=0)));
end SVPWM;
...
block ChopperPWM_I "Chopper PWM (current)"
  ...
  annotation (Placement(transformation(
          ...
          extent={{-10,-10},{10,10}},
          rotation=270)));
    Modelica.Blocks.Interfaces.RealInput iSet "desired current" annotation (
        Placement(transformation(extent={{-110,-10},{-90,10}}, rotation=0)));
    Modelica.Blocks.Interfaces.RealInput iMeas "measured current" annotation (
        Placement(transformation(extent={{110,-10},{90,10}}, rotation=0)));
  protected
  SI.Current di;
