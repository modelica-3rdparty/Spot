...
"),
  ...
  model BusBar "Busbar, 3-phase dqo"
    ...
    Base.Interfaces.ACdqo_p term "bus bar"
  annotation (
  ...
  protected
    Real[2,2] R = Base.Transforms.rotation_dq(term.theta[1]);
...
"));
  ...
  model Y_Delta "Y_Delta switch, 3-phase dqo"
    ...
    Base.Interfaces.ACdqo_p term_p "connect to non source side of windings"
  annotation (extent=[110,-70; 90,-50]);
    Base.Interfaces.ACdqo_n term_n "connect to source side of windings"
...
"),
  ...
  Diagram(
    ...
    Base.Interfaces.ElectricV_p switchY(final m=3)
      "connect to switch 'Y' position"  annotation (extent=[108,30; 88,50]);
...
"),   Icon(
  Rectangle(extent=[-80,80; 80,-80], style(
      ...
      Line(points=[-80,60; -40,60; 20,0; -40,-60; -80,-60], style(
            color=62,
            rgbcolor={0,100,100},
            fillColor=62,
            rgbfillColor={0,100,100})),
      ...
      Diagram(
      Line(points=[-80,0; 20,0], style(color=62, rgbcolor={0,100,100})),
      Line(points=[-80,60; -40,60; 20,0; -40,-60; -80,-60], style(color=62,
              rgbcolor={0,100,100})),
      Ellipse(extent=[14,6; 26,-6], style(
            color=62,
            rgbcolor={0,100,100},
  ...
  Text(
    ...
    string="neutral point",
          style(color=62, rgbcolor={0,100,100})),
      Line(points=[26,0; 90,0])));
...
"),
  ...
  fillColor=10,
  fillPattern=1)),
        Line(points=[-80,0; -40,0], style(color=62, rgbcolor={0,100,100})),
        Rectangle(extent=[-20,30; 94,-30], style(
            ...
            fillColor=7,
            rgbfillColor={255,255,255})),
        Line(points=[-80,60; -60,60; -40,0; -60,-60; -80,-60], style(color=62,
              rgbcolor={0,100,100})),
...
"),
  Icon( Line(points=[-80,0; -40,0], style(color=62, rgbcolor={0,100,100})),
        Line(points=[-80,60; -60,60; -40,0; -60,-60; -80,-60], style(color=62,
              rgbcolor={0,100,100})),
        Ellipse(extent=[-46,6; -34,-6], style(
            color=62,
  ...
  fillColor=10,
  fillPattern=1)),
        Rectangle(extent=[-20,30; 10,-30], style(
            color=3,
            rgbcolor={0,0,255},
            gradient=0,
            fillColor=7,
...
model Y_OnePhase "Terminator, ACdqo to an, bn, cn"
  extends Ports.Port_p;
  extends Base.Icons.Adaptor_dqo;

  Base.Interfaces.Electric_p neutral "neutral Y"
                                annotation (extent=[-10,-90; 10,-70],  rotation=
       90);
  ...
  Base.Interfaces.ElectricV_n plug_c(final m=2) "phase c and neutral"
                                                 annotation (extent=[90,-50;
          110,-30]);
  protected
  Real[3,3] P = Base.Transforms.park(term.theta[2]);
...
equation
  plug_a.pin.v = cat(1, transpose(P[:, 1:1])*term.v, {neutral.v});
  plug_b.pin.v = cat(1, transpose(P[:, 2:2])*term.v, {neutral.v});
