...
package Governors "Turbine Governors "
  ...
  block GovernorSimple "Simple governor for constant turbine power"
    ...
    Modelica.Blocks.Interfaces.RealInput speed(final unit="pu")
      "speed of turbine pu" annotation (Placement(transformation(
          origin={-60,-100},
          extent={{-10,-10},{10,10}},
          rotation=90)));
    Modelica.Blocks.Interfaces.RealOutput power(final unit="pu")
...
"),   Icon(coordinateSystem(
  ...
  partial block GovernorBase "Governor base"
    ...
    outer System system;
    public
      Modelica.Blocks.Interfaces.RealInput setptPower(final unit="pu")
        "setpoint power pu" annotation (Placement(transformation(extent={{-110,
                -50},{-90,-30}}, rotation=0)));
      Modelica.Blocks.Interfaces.RealInput setptSpeed(final unit="pu")
        "setpoint speed pu" annotation (Placement(transformation(extent={{-110,
                30},{-90,50}}, rotation=0)));
      Modelica.Blocks.Interfaces.RealInput speed(final unit="pu")
