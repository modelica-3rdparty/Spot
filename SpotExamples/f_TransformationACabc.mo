...
"),   Diagram,
    ...
    Spot.ACabc.Sources.Voltage voltage
      annotation (
            extent=[-90,-10; -70,10]);
    Spot.ACabc.Sensors.PVImeter meter1(phasor=true)
      annotation (
            extent=[-60,-10; -40,10]);
    Spot.ACabc.Nodes.BusBar bus      annotation (extent=[-30,-10; -10,10]);
    Spot.ACabc.Transformers.TrafoStray trafo1(par(
      V_nom={1,10}),
      redeclare Spot.ACabc.Ports.Topology.Y top_p "Y",
      redeclare Spot.ACabc.Ports.Topology.Y top_n "Y")
                           annotation (extent=[0,20; 20,40]);
    Spot.ACabc.Sensors.PVImeter meter12(V_nom=10, phasor=true)
      annotation (
            extent=[40,20; 60,40]);
    Spot.ACabc.ImpedancesYD.Resistor res12(V_nom=10, r=1000)
                                           annotation (extent=[80,20; 100,40]);
    Spot.ACabc.Transformers.TrafoStray trafo2(par(
      V_nom={1,10}),
      redeclare Spot.ACabc.Ports.Topology.Y top_p "Y",
      redeclare Spot.ACabc.Ports.Topology.Delta top_n "Delta")
                           annotation (extent=[0,-40; 20,-20]);
    Spot.ACabc.Sensors.PVImeter meter22(phasor=true, V_nom=10)
      annotation (
            extent=[40,-40; 60,-20]);
    Spot.ACabc.ImpedancesYD.Resistor res22(V_nom=10, r=1000)
                                           annotation (extent=[80,-40; 100,-20]);
    Spot.ACabc.Nodes.GroundOne grd annotation (extent=[-90,-10; -110,10]);
  ...
  equation
    connect(voltage.term, meter1.term_p) annotation (points=[-70,0; -60,0],
        ...
        fillPattern=1));
    connect(meter1.term_n, bus.term) annotation (points=[-40,0; -20,0], style(
        color=70,
        rgbcolor={0,130,175},
        fillColor=62,
        rgbfillColor={0,120,120},
...
"), Diagram,
  ...
  Spot.ACabc.Transformers.Trafo3Stray trafo3Stray
